...
while ~isDone(obj.reader)
    ...
    [v,a]=predictNewLocationsOfTracks(v,a);
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader('u.mp4');
...
% current frame, and update its bounding box accordingly.
    ...
    function [v,a]=predictNewLocationsOfTracks(v,a)
        ...
        if ~isempty(tracks)
            ...
            if ~isempty(reliableTracks)
             ...
             if(x>3)
                ...
                mask = insertObjectAnnotation(mask,'rectangle',bboxes, labels,'Color','red');
